...
namespace HelpGent\WpMVC\Routing;

use HelpGent\WpMVC\Routing\Providers\RouteServiceProvider;
use HelpGent\WpMVC\Routing\Contracts\Middleware as MiddlewareContract;
use WP_Error;
class Middleware
{
