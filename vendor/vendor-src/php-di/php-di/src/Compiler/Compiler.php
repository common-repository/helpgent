...
namespace HelpGent\DI\Compiler;

use function chmod;
use HelpGent\DI\Definition\ArrayDefinition;
use HelpGent\DI\Definition\DecoratorDefinition;
...
use HelpGent\DI\Definition\Source\DefinitionSource;
use HelpGent\DI\Definition\StringDefinition;
use HelpGent\DI\Definition\ValueDefinition;
use HelpGent\DI\DependencyException;
use HelpGent\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use HelpGent\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
