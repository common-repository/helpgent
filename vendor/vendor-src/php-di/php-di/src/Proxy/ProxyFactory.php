...
namespace HelpGent\DI\Proxy;

use HelpGent\ProxyManager\Configuration;
use HelpGent\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use HelpGent\ProxyManager\FileLocator\FileLocator;
use HelpGent\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use HelpGent\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use HelpGent\ProxyManager\Proxy\LazyLoadingInterface;
/**
